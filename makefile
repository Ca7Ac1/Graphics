...
compile_gallery: gallery.o window.o graphics.o renderer.o matrix.o script.o transform.o graphics3d.o context.o
	g++ -std=c++11 -o gallery.exe gallery.o window.o graphics.o renderer.o script.o transform.o matrix.o graphics3d.o context.o

compile: main.o window.o graphics.o renderer.o matrix.o script.o transform.o graphics3d.o context.o
	g++ -std=c++11 -o main.exe main.o window.o graphics.o renderer.o script.o transform.o matrix.o graphics3d.o context.o
...
renderer.o: renderer.cpp renderer.hpp window.hpp graphics.hpp graphics3d.hpp context.hpp
	g++ -std=c++11 -c renderer.cpp

contexdt.o: context.cpp context.hpp transform.hpp graphics.hpp graphics3d.hpp
