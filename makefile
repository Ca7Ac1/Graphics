...
compile_gallery: gallery.o window.o graphics.o renderer.o matrix.o script.o transform.o graphics3d.o context.o lighting.o
	g++ -std=c++11 -o gallery.exe gallery.o window.o graphics.o renderer.o script.o transform.o matrix.o graphics3d.o context.o lighting.o

compile: main.o window.o graphics.o renderer.o matrix.o script.o transform.o graphics3d.o context.o lighting.o
	g++ -std=c++11 -o main.exe main.o window.o graphics.o renderer.o script.o transform.o matrix.o graphics3d.o context.o lighting.o
