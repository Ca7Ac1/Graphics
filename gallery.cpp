...
int main()
{
    ...
    g3d.setDiffuse(.2, .2, .2);
    g3d.setSpecular(.4, .4, .4);
    ...
    Color c[] = {Color(255,182,193), Color(219,240,220), Color(255,182,193), Color(219,240,220)};
    Point p[] = {Point(0, 0, 1), Point(1, 0, 0), Point(0, 1, 0), Point(0, -1, 0)};
    
    for (int i = 0; i < 4; i++)
    {

        r.setColor(c[i].getRed(), c[i].getGreen(), c[i].getBlue());
        r.addPointLight(p[i][0], p[i][1], p[i][2]);
    }
